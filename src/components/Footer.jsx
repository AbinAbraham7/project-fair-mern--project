import { faStackOverflow,faXTwitter, faFacebook,faInstagram,faWhatsapp} from '@fortawesome/free-brands-svg-icons'
    ...
    <div className='container-fluid'>
        <div className="row">
            <div className="col-md-4">
                ...
                <p className='mt-3' style={{textAlign:"justify"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio fuga accusantium deserunt facere quaerat? Veritatis voluptatibus asperiores eaque in.</p>
            </div>
            ...
            <div className="col-md-3">
                ...
                <div className='d-md-flex mt-3'>
                    ...
                    <button className='btn btn-warning ms-md-2 ms-0 rounded-0 mt-md-0 mt-3'>Subscribe</button>
                </div>
